          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <SearchableSelect
                ...
                className="mt-1"
              />
              {errors.clientId && <p className="text-sm text-red-500 mt-1">Client is required</p>}
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Time</label>
              <div className="mt-1 relative">
                <Input type="time" {...register('time')} className="block w-full" />
                <Clock className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
              </div>
            </div>
            ...
            {meetingType === 'physical' && (
              <div className="col-span-2">
                <label className="block text-sm font-medium text-gray-700">Location</label>
                <Input {...register('location')} placeholder="Enter meeting location" className="mt-1" />
              </div>
            )}
            ...
            {meetingType === 'online' && (
              <div className="col-span-2">
                <label className="block text-sm font-medium text-gray-700">Meeting Link</label>
                <Input {...register('meetingLink')} placeholder="Enter online meeting link" className="mt-1" />
              </div>
            )}
