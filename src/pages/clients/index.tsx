...
//         // toast.success('client fechted sucess')
//       }
//       else{
...
//   );
// }
//  fix the eye button size and make sure when user click then download txt file  with client detail like name phone addresss
