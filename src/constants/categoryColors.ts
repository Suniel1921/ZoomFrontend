...
export const categoryColors: Record<ClientCategory, { bg: string; text: string }> = {
  ...
  'Epassport Applicant': { bg: 'bg-orange-100', text: 'text-orange-700' },
  'Japan Visa': { bg: 'bg-red-100', text: 'text-red-700' },
  'Graphic Design & Printing': { bg: 'bg-teal-100', text: 'text-teal-700' },
  'Web Design & Seo': { bg: 'bg-indigo-100', text: 'text-indigo-700' },
  'Birth Registration': { bg: 'bg-yellow-100', text: 'text-yellow-700' },
  'Documentation Support': { bg: 'bg-gray-100', text: 'text-gray-700' },
  'Other': { bg: 'bg-cyan-100', text: 'text-cyan-700' },
};