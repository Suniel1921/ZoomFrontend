...
// ********************break in small component (above code is also working)*************************
import React, { useState, useEffect, useRef, useCallback } from "react";
  ...
  return (
    <div className="flex h-screen bg-white text-gray-800">
      ...
      <ChatList
        ...
        unreadCounts={unreadCounts} // Pass unreadCounts to ChatList
      />
      <div className="flex-1 flex flex-col h-screen">
        {selectedChat.id ? (
          <div className="flex flex-col h-full">
...
// //no no its not working listen what i want solve this below problem one by one : 
// 1. show profilePhoto everywhere if profilephoto is available
// 2. add sepecific msg reply (my approach is when when hover on sepecifi msg then show the reply option and then send reply to sepefic reply if you have better apporach use your)
// 3. make sure when page refresh message still show (in this code when i refresh the page then msg not showing)
// 4. add pin chat functionality
// 4. show all shared links and files 